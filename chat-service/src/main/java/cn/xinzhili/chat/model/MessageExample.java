...
public class MessageExample {
     ...
     * This field corresponds to the database table s_message.t_message
     *
     ...
     * This class corresponds to the database table s_message.t_message
     *
     * @mbggenerated Tue May 08 17:07:36 CST 2018
     */
    protected abstract static class GeneratedCriteria {
        ...
        protected List<Criterion> messageTypeCriteria;
        ...
        protected GeneratedCriteria() {
            ...
            messageTypeCriteria = new ArrayList<Criterion>();
        }
        ...
        public List<Criterion> getMessageTypeCriteria() {
            return messageTypeCriteria;
        }

        protected void addMessageTypeCriterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            messageTypeCriteria.add(new Criterion(condition, value, "cn.xinzhili.xutils.mybatis.typehandlers.EnumCodeHandler"));
            allCriteria = null;
        }

        protected void addMessageTypeCriterion(String condition, MessageType value1, MessageType value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            messageTypeCriteria.add(new Criterion(condition, value1, value2, "cn.xinzhili.xutils.mybatis.typehandlers.EnumCodeHandler"));
            allCriteria = null;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(messageTypeCriteria);
            }
            return allCriteria;
        }
        ...
        public Criteria andMessageTypeEqualTo(MessageType value) {
            addMessageTypeCriterion("message_type =", value, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeNotEqualTo(MessageType value) {
            addMessageTypeCriterion("message_type <>", value, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeGreaterThan(MessageType value) {
            addMessageTypeCriterion("message_type >", value, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeGreaterThanOrEqualTo(MessageType value) {
            addMessageTypeCriterion("message_type >=", value, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeLessThan(MessageType value) {
            addMessageTypeCriterion("message_type <", value, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeLessThanOrEqualTo(MessageType value) {
            addMessageTypeCriterion("message_type <=", value, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeIn(List<MessageType> values) {
            addMessageTypeCriterion("message_type in", values, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeNotIn(List<MessageType> values) {
            addMessageTypeCriterion("message_type not in", values, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeBetween(MessageType value1, MessageType value2) {
            addMessageTypeCriterion("message_type between", value1, value2, "messageType");
            return (Criteria) this;
        }

        public Criteria andMessageTypeNotBetween(MessageType value1, MessageType value2) {
            addMessageTypeCriterion("message_type not between", value1, value2, "messageType");
            return (Criteria) this;
        }
