...
import cn.xinzhili.api.doctor.bean.response.MedicineAdjustmentClient.Builder;
...
public class MedicineAdjustmentClient {
  ...
  private MedicineAdjustmentClient(Builder builder) {
    id = builder.id;
    name = builder.name;
  ...
  public MedicineAdjustmentClient() {
  }

  public MedicineAdjustmentClient(String id, String name, String markId, String unit,
  ...
  /**
   * {@code MedicineAdjustmentClient} builder static inner class.
   */
  ...
  public static final class Builder {
    ...
    /**
     * Returns a {@code MedicineAdjustmentClient} built from the parameters previously set.
     *
     * @return a {@code MedicineAdjustmentClient} built with parameters of this {@code
     * MedicineAdjustmentClient.Builder}
     */
    public MedicineAdjustmentClient build() {
      return new MedicineAdjustmentClient(this);
    }
  }
}