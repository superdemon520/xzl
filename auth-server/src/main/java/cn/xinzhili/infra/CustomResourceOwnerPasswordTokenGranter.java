...
public class CustomResourceOwnerPasswordTokenGranter extends
  ...
  protected OAuth2Authentication getOAuth2Authentication(ClientDetails client,
    ...
    if (CommonConsts.CLIENT_PATIENT.equalsIgnoreCase(clientId)) {
      userAuth = new PatientUsernamePasswordAuthenticationToken(username,
          password);
    } else if (CommonConsts.CLIENT_DOCTOR.equalsIgnoreCase(clientId)) {
      userAuth = new DoctorUsernamePasswordAuthenticationToken(username,
          password);
    } else {
